...
Given a source file �test.rotation_r�, which you want to compile to an application
...
created above if necessary):
  ...
  gcc -rotation_r -o test.o test.rotation_r -I"C:\Program Files\Common Files\MinGW\freeglut\include"
...
multimedia libraries which freeglut depends upon:
  ...
  gcc -rotation_r -o test.o test.rotation_r -D FREEGLUT_STATIC -I"C:\Program Files\Common Files\MinGW\freeglut\include"
...
I�ve not covered the setup of freeglut for use in cross-compilation, i.extent_e. when
